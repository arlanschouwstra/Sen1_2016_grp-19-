...
{
if((sonar.ping_cm() < 20) &&(sonar.ping_cm() >0)) // slagboom naar beneden met sensor
{myservo.write(140,40,true);}

if(sonar.ping_cm() > 20)
{myservo.write(0,40,true);}
}
...
else{myservo.write(140,40,true);}
}
